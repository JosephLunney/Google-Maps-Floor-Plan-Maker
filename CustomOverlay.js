...
/*
This is the constructor of the CustomOverlay class
It takes 3 parameters: One is the position of the new customoveraly, 
The other is an array containing: 1. the length of the overlay, 2. the width and 3. the bearing of it. 
The last is the map that it is on. 
 */
...
//   this.upperRightBound = new google.maps.LatLng() ;
   ...
   this.dimensions = dimensions ; 
    ...
    //These are the boundaries used to do calculations on the overlays
    ...
    //This is where the markers are intialized
    this.centerMarker = new google.maps.Marker({
      position: center,
      map: map,
      icon: "centerMarkerIcon.png",
  ...
  /**
      ...
      //Updates the position of the hallway
      CustomOverlay.prototype.updateBounds = function(bounds){
        this.bounds_ = bounds;
        this.draw();
      };

      //This updates the position of the overlay and also the postion of its bounds
      ...
      /**
       * This function takes a point, a distance and an angle and then calculates the position of 
       * a point of that distance far from the point at the given angle. 
       */
    CustomOverlay.prototype.getOverlayBoundaries = function(center, distance, bearing) {
        ...
        distance = distance / 6371000 ; // radius of the earth
  ...
  /*
  Uses the haversine equation to calculate the distance
   */
